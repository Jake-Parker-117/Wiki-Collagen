...
if __name__ == '__main__':
    ...
    serve(app, host='0.0.0.0', port=5000, threads=2, max_request_body_size=1073741824) 
    #switching to single thread on waitress so background gpu threads take care of the processing
